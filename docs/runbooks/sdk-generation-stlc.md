...
preview branches and manifest diagnostics before merging. The production `next` branches and release-please PRs are updated automatically;
publishing requires merging the release-please PRs.
