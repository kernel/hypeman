...
// Note: Also recovers "queued" status for backward compatibility with builds created
// before the queue was removed - these are treated as pending and will be started.
