...
const (
	...
	GuestService_ArmResumeNetwork_FullMethodName   = "/guest.GuestService/ArmResumeNetwork"
)
...
type GuestServiceClient interface {
	...
	// ArmResumeNetwork puts the guest-initiated resume network watcher into its fast reconnect loop
	ArmResumeNetwork(ctx context.Context, in *ArmResumeNetworkRequest, opts ...grpc.CallOption) (*ArmResumeNetworkResponse, error)
}
...
func (c *guestServiceClient) ReconfigureNetwork(ctx context.Context, in *ReconfigureNetworkRequest, opts ...grpc.CallOption) (*ReconfigureNetworkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReconfigureNetworkResponse)
	err := c.cc.Invoke(ctx, GuestService_ReconfigureNetwork_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *guestServiceClient) ArmResumeNetwork(ctx context.Context, in *ArmResumeNetworkRequest, opts ...grpc.CallOption) (*ArmResumeNetworkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArmResumeNetworkResponse)
	err := c.cc.Invoke(ctx, GuestService_ArmResumeNetwork_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GuestServiceServer interface {
	...
	// ArmResumeNetwork puts the guest-initiated resume network watcher into its fast reconnect loop
	ArmResumeNetwork(context.Context, *ArmResumeNetworkRequest) (*ArmResumeNetworkResponse, error)
...
func (UnimplementedGuestServiceServer) ArmResumeNetwork(context.Context, *ArmResumeNetworkRequest) (*ArmResumeNetworkResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ArmResumeNetwork not implemented")
}
...
func _GuestService_ReconfigureNetwork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReconfigureNetworkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GuestServiceServer).ReconfigureNetwork(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GuestService_ReconfigureNetwork_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GuestServiceServer).ReconfigureNetwork(ctx, req.(*ReconfigureNetworkRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GuestService_ArmResumeNetwork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArmResumeNetworkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GuestServiceServer).ArmResumeNetwork(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GuestService_ArmResumeNetwork_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GuestServiceServer).ArmResumeNetwork(ctx, req.(*ArmResumeNetworkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GuestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ArmResumeNetwork",
			Handler:    _GuestService_ArmResumeNetwork_Handler,
		},
	},
