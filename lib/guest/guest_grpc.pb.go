...
const (
	...
	GuestService_RebindIdentity_FullMethodName     = "/guest.GuestService/RebindIdentity"
)
...
type GuestServiceClient interface {
	...
	RebindIdentity(ctx context.Context, in *RebindIdentityRequest, opts ...grpc.CallOption) (*RebindIdentityResponse, error)
}
...
func (c *guestServiceClient) RebindIdentity(ctx context.Context, in *RebindIdentityRequest, opts ...grpc.CallOption) (*RebindIdentityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RebindIdentityResponse)
	err := c.cc.Invoke(ctx, GuestService_RebindIdentity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GuestServiceServer interface {
	...
	// RebindIdentity assigns a forked guest a new machine identity.
	RebindIdentity(context.Context, *RebindIdentityRequest) (*RebindIdentityResponse, error)
...
func (UnimplementedGuestServiceServer) RebindIdentity(context.Context, *RebindIdentityRequest) (*RebindIdentityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RebindIdentity not implemented")
}
...
func _GuestService_RebindIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RebindIdentityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GuestServiceServer).RebindIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GuestService_RebindIdentity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GuestServiceServer).RebindIdentity(ctx, req.(*RebindIdentityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GuestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RebindIdentity",
			Handler:    _GuestService_RebindIdentity_Handler,
		},
	},
