...
type ReconfigureNetworkRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InterfaceName string                 `protobuf:"bytes,1,opt,name=interface_name,json=interfaceName,proto3" json:"interface_name,omitempty"` // Interface to reconfigure, defaults to eth0
	Mac           string                 `protobuf:"bytes,2,opt,name=mac,proto3" json:"mac,omitempty"`                                          // New MAC address
...
func (x *ReconfigureNetworkRequest) Reset() {
	*x = ReconfigureNetworkRequest{}
	mi := &file_lib_guest_guest_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReconfigureNetworkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReconfigureNetworkRequest) ProtoMessage() {}

func (x *ReconfigureNetworkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lib_guest_guest_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReconfigureNetworkRequest.ProtoReflect.Descriptor instead.
func (*ReconfigureNetworkRequest) Descriptor() ([]byte, []int) {
	return file_lib_guest_guest_proto_rawDescGZIP(), []int{17}
}

func (x *ReconfigureNetworkRequest) GetInterfaceName() string {
	if x != nil {
...
func (x *ReconfigureNetworkRequest) GetMac() string {
	if x != nil {
		return x.Mac
	}
	return ""
...
func (x *ReconfigureNetworkRequest) GetIpv4() string {
	if x != nil {
		return x.Ipv4
	}
	return ""
...
func (x *ReconfigureNetworkRequest) GetPrefix() uint32 {
	if x != nil {
		return x.Prefix
	}
	return 0
...
func (x *ReconfigureNetworkRequest) GetGateway() string {
	if x != nil {
		return x.Gateway
	}
	return ""
...
type ReconfigureNetworkResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReconfigureNetworkResponse) Reset() {
	*x = ReconfigureNetworkResponse{}
	mi := &file_lib_guest_guest_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReconfigureNetworkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReconfigureNetworkResponse) ProtoMessage() {}

func (x *ReconfigureNetworkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lib_guest_guest_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReconfigureNetworkResponse.ProtoReflect.Descriptor instead.
func (*ReconfigureNetworkResponse) Descriptor() ([]byte, []int) {
	return file_lib_guest_guest_proto_rawDescGZIP(), []int{18}
}

// ArmResumeNetworkRequest arms the guest-side fast reconnect loop before snapshot
type ArmResumeNetworkRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	PollIntervalMs uint32                 `protobuf:"varint,1,opt,name=poll_interval_ms,json=pollIntervalMs,proto3" json:"poll_interval_ms,omitempty"` // Fast reconnect interval while armed; 0 uses the guest default
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *ArmResumeNetworkRequest) Reset() {
	*x = ArmResumeNetworkRequest{}
	mi := &file_lib_guest_guest_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArmResumeNetworkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArmResumeNetworkRequest) ProtoMessage() {}

func (x *ArmResumeNetworkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lib_guest_guest_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArmResumeNetworkRequest.ProtoReflect.Descriptor instead.
func (*ArmResumeNetworkRequest) Descriptor() ([]byte, []int) {
	return file_lib_guest_guest_proto_rawDescGZIP(), []int{19}
}

func (x *ArmResumeNetworkRequest) GetPollIntervalMs() uint32 {
	if x != nil {
...
// ArmResumeNetworkResponse acknowledges that the fast reconnect loop is armed
type ArmResumeNetworkResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ArmResumeNetworkResponse) Reset() {
	*x = ArmResumeNetworkResponse{}
	mi := &file_lib_guest_guest_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArmResumeNetworkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArmResumeNetworkResponse) ProtoMessage() {}

func (x *ArmResumeNetworkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lib_guest_guest_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArmResumeNetworkResponse.ProtoReflect.Descriptor instead.
func (*ArmResumeNetworkResponse) Descriptor() ([]byte, []int) {
...
const file_lib_guest_guest_proto_rawDesc = "" +
	...
	"\x10ArmResumeNetwork\x12\x1e.guest.ArmResumeNetworkRequest\x1a\x1f.guest.ArmResumeNetworkResponseB'Z%github.com/onkernel/hypeman/lib/guestb\x06proto3"
...
var file_lib_guest_guest_proto_goTypes = []any{
	...
	(*ArmResumeNetworkRequest)(nil),    // 19: guest.ArmResumeNetworkRequest
	(*ArmResumeNetworkResponse)(nil),   // 20: guest.ArmResumeNetworkResponse
...
var file_lib_guest_guest_proto_depIdxs = []int32{
	...
	19, // 14: guest.GuestService.ArmResumeNetwork:input_type -> guest.ArmResumeNetworkRequest
	...
	20, // 21: guest.GuestService.ArmResumeNetwork:output_type -> guest.ArmResumeNetworkResponse
