...
var file_lib_guest_guest_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_lib_guest_guest_proto_goTypes = []any{
	(*ExecRequest)(nil),           // 0: guest.ExecRequest
	(*ExecStart)(nil),             // 1: guest.ExecStart
	(*ExecResponse)(nil),          // 2: guest.ExecResponse
	(*CopyToGuestRequest)(nil),    // 3: guest.CopyToGuestRequest
	(*CopyToGuestStart)(nil),      // 4: guest.CopyToGuestStart
	(*CopyToGuestEnd)(nil),        // 5: guest.CopyToGuestEnd
	(*CopyToGuestResponse)(nil),   // 6: guest.CopyToGuestResponse
	(*CopyFromGuestRequest)(nil),  // 7: guest.CopyFromGuestRequest
	(*CopyFromGuestResponse)(nil), // 8: guest.CopyFromGuestResponse
	(*CopyFromGuestHeader)(nil),   // 9: guest.CopyFromGuestHeader
	(*CopyFromGuestEnd)(nil),      // 10: guest.CopyFromGuestEnd
	(*CopyFromGuestError)(nil),    // 11: guest.CopyFromGuestError
	(*StatPathRequest)(nil),       // 12: guest.StatPathRequest
	(*StatPathResponse)(nil),      // 13: guest.StatPathResponse
	nil,                           // 14: guest.ExecStart.EnvEntry
}
var file_lib_guest_guest_proto_depIdxs = []int32{
	1,  // 0: guest.ExecRequest.start:type_name -> guest.ExecStart
	14, // 1: guest.ExecStart.env:type_name -> guest.ExecStart.EnvEntry
	4,  // 2: guest.CopyToGuestRequest.start:type_name -> guest.CopyToGuestStart
	5,  // 3: guest.CopyToGuestRequest.end:type_name -> guest.CopyToGuestEnd
	9,  // 4: guest.CopyFromGuestResponse.header:type_name -> guest.CopyFromGuestHeader
	10, // 5: guest.CopyFromGuestResponse.end:type_name -> guest.CopyFromGuestEnd
	11, // 6: guest.CopyFromGuestResponse.error:type_name -> guest.CopyFromGuestError
	0,  // 7: guest.GuestService.Exec:input_type -> guest.ExecRequest
	3,  // 8: guest.GuestService.CopyToGuest:input_type -> guest.CopyToGuestRequest
	7,  // 9: guest.GuestService.CopyFromGuest:input_type -> guest.CopyFromGuestRequest
	12, // 10: guest.GuestService.StatPath:input_type -> guest.StatPathRequest
	2,  // 11: guest.GuestService.Exec:output_type -> guest.ExecResponse
	6,  // 12: guest.GuestService.CopyToGuest:output_type -> guest.CopyToGuestResponse
	8,  // 13: guest.GuestService.CopyFromGuest:output_type -> guest.CopyFromGuestResponse
	13, // 14: guest.GuestService.StatPath:output_type -> guest.StatPathResponse
...
func file_lib_guest_guest_proto_init() {
	...
	file_lib_guest_guest_proto_msgTypes[2].OneofWrappers = []any{
	...
	file_lib_guest_guest_proto_msgTypes[8].OneofWrappers = []any{
