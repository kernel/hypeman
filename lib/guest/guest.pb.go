...
type ExecSession int32

const (
	ExecSession_EXEC_SESSION_SYSTEM  ExecSession = 0
	ExecSession_EXEC_SESSION_DESKTOP ExecSession = 1
)

// Enum value maps for ExecSession.
var (
	ExecSession_name = map[int32]string{
		0: "EXEC_SESSION_SYSTEM",
		1: "EXEC_SESSION_DESKTOP",
	}
	ExecSession_value = map[string]int32{
		"EXEC_SESSION_SYSTEM":  0,
		"EXEC_SESSION_DESKTOP": 1,
	}
)

func (x ExecSession) Enum() *ExecSession {
	p := new(ExecSession)
	*p = x
	return p
}
...
func (ExecSession) Descriptor() protoreflect.EnumDescriptor {
	return file_lib_guest_guest_proto_enumTypes[0].Descriptor()
}

func (ExecSession) Type() protoreflect.EnumType {
	return &file_lib_guest_guest_proto_enumTypes[0]
}

func (x ExecSession) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ExecSession.Descriptor instead.
func (ExecSession) EnumDescriptor() ([]byte, []int) {
...
type ExecStart struct {
	...
	Session        ExecSession            `protobuf:"varint,8,opt,name=session,proto3,enum=guest.ExecSession" json:"session,omitempty"`                                           // SYSTEM service session or active desktop user
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ExecStart) GetSession() ExecSession {
	if x != nil {
		return x.Session
	}
	return ExecSession_EXEC_SESSION_SYSTEM
}
...
var file_lib_guest_guest_proto_depIdxs = []int32{
	...
	11, // 6: guest.CopyFromGuestResponse.header:type_name -> guest.CopyFromGuestHeader
	12, // 7: guest.CopyFromGuestResponse.end:type_name -> guest.CopyFromGuestEnd
	13, // 8: guest.CopyFromGuestResponse.error:type_name -> guest.CopyFromGuestError
