...
terminal `HYPEMAN-GPU-INIT-OK` marker and suppresses later failure reports. The
marker clears failures only when that exact assignment has a recorded failure,
